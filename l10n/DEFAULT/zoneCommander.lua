...
do
	...
	function BattleCommander:init()
		...
		local ev = {}
		function ev:onEvent(event)
			if event.id==20 and event.initiator and Object.getCategory(event.initiator) == Object.Category.UNIT and (event.initiator:getCategory() == Unit.Category.AIRPLANE or event.initiator:getCategory() == Unit.Category.HELICOPTER) then
	...
	function BattleCommander:startRewardPlayerContribution(defaultReward, rewards)
		...
		function ev:onEvent(event)
			...
			if unit and Object.getCategory(unit) == Object.Category.UNIT and (unit:getCategory() == Unit.Category.AIRPLANE or unit:getCategory() == Unit.Category.HELICOPTER) then
	...
	function BattleCommander:objectToRewardPoints(object) -- returns points,message
		if object:getCategory() == Object.Category.UNIT then
			local targetType = object:getCategory()
